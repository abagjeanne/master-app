...
setInterval(fetchServerInfo, 1000);
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#" style="margin-left: 0px;"><span style="font-size: 22px;">GDS Group - Work From Home Site</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1" style="margin-left: 6px;margin-right: -17px;font-size: 14px;">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item" style="font-size: 18px;"><a class="nav-link active" href="index.php">Home</a></li>
    ...
    <div>
        <div class="container py-4 py-xl-5" style="margin-bottom: -100px;">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style="font-size: 27px;">Welcome to the GDS Group of Companies</h2>
                    <p class="w-lg-50" style="font-size: 13px;">Work from Home Resources Site</p>
                    <p class="w-lg-50" style="font-size: 15px;">This website composed of various options and resources for our staff/employees under the GDS Group of Companies to access Company Resources at the comfort of their homes for Work From Home, Hybrid, and On-Site office works.</p>
                </div>
            </div>
        </div>
        <div class="container py-4 py-xl-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style="font-size: 27px;">COMPANIES</h2>
                </div>
            </div>
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col" style="margin-top: 5px;margin-bottom: 5px;"><a href="#"><img src="assets/img/3.png" style="width: 280px;text-align: left;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">GDS CAPITAL INCORPORATED</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col" style="margin-top: 5px;margin-bottom: 5px;"><a href="#"><img src="assets/img/PDMN.png" style="width: 280px;text-align: left;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">PHILIPPINE DRAGON MEDIA NETWORK CORPORATION</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col"><a href="#"><img src="assets/img/SUPERNOVA%20-%2010.12.23.png" style="text-align: left;width: 280px;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">SUPERNOVA INNOVATION INCORPORATED</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col"><a href="#"><img src="assets/img/GDS%20Travel.png" style="text-align: left;width: 280px;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">GDS INTERNATIONAL TRAVEL AGENCY INCORPORATED</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col"><a href="#"><img src="assets/img/Voltion品牌LOGO最终版%20(all%20black).png" style="text-align: left;width: 280px;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">VOLTION MOTORS PHILIPPINES</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Companies</span>
                        <div class="row" style="text-align: center;">
                            <div class="col"><a href="#"><img src="assets/img/Starlight.png" style="text-align: left;width: 280px;"></a></div>
                        </div>
                        <p style="text-align: center;font-weight: bold;font-size: 18px;">STARLIGHT BUSINESS CONSULTING SERVICES INCORPORATED</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container py-4 py-xl-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style="font-size: 27px;">LINKS</h2>
                </div>
            </div>
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Links</span><a href="#">
                        ...
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50" height="50" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
                            <div>
                                <p class="fw-bold mb-0">Jan Wilbert See</p>
                ...
                <div class="col">
                    <div class="p-4"><span class="badge rounded-pill bg-primary mb-2">Links</span><a href="#">
                            <h4>IT Department Management Access</h4>
                        </a>
                        <p>Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50" height="50" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png">
                            <div>
        ...
        <div class="container py-4 py-xl-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style="font-size: 27px;">INFORMATION</h2>
                </div>
            </div>
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                <div class="col">
