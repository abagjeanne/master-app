...
const ViewLink = () => {
  ...
  return (
    <div className="container-fluid" style={{ backgroundColor: "#222840", color: "white" }}>
      <div className="container py-4">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <Link to="/admin/dashboard" className="btn btn-primary"><FontAwesomeIcon icon={faArrowLeft} /> Back to Dashboard</Link>
          <div className="button-container">
            <button className="btn btn-primary m-1 mr-2" onClick={handleEdit}><FontAwesomeIcon icon={faEdit} /> Edit</button>
            <button className="btn btn-danger m-1 mr-2" onClick={handleDeleteConfirmation}><FontAwesomeIcon icon={faTrash} /> Delete</button>
            <button className="btn btn-light m-1" onClick={handleArchive}><FontAwesomeIcon icon={faArchive} /> Archive</button>
          </div>
        </div>
        <div className="row justify-content-center" >
          <div className="col-md-15"> 
            <div className="card shadow-lg" style={{ backgroundColor: "#131633", color: "white" }}>
